...
import alphaSource from '../images/textures/planet/clouds/alpha.jpg'
...
export default class Planet {
    ...
    setGlobe() {
        ...
        this.globe.mesh = new THREE.Mesh(
            this.globe.geometry,
            this.globe.material
        )
    ...
    setClouds() {
        this.clouds = {
            geometry: new THREE.SphereBufferGeometry(1.01, 32, 32),
            material: new THREE.MeshStandardMaterial({
                alphaMap: this.textureLoader.load(alphaSource),
                transparent: true
            })
        }
    ...
    setBelt() {
        ...
        this.belt.points = new THREE.Points(
            this.belt.geometry,
            this.belt.material
        )
    ...
    setAnimation() {
        const loop = () => {
            ...
            this.clouds.mesh.rotation.y += 0.0007
